            ...
            <div class="row align-items-center">
                ...
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                    <div class="bread-tag">
                        ...
                        <span> / </span>
                        <a href="career.php" class="active" data-sal-delay="450" data-sal="slide-up" data-sal-duration="800">Careers</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="copyu-right-wrapper">
                        ...
                        <div class="left single">
                        <p class="dot"> &copy; 2023 Itchealthcarestaffing by <a href="https://www.dotweb.in" target="_blank"> <span class="dot">Dotweb.in</span></a></p>
