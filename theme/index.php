...
<body class="index-two">
    ...
    <!-- <div class="header-top-start header-three d-none d-xl-block">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-6">
                    <div class="left">
                        <p>The best journeys in life are those that answers questions you never thought to ask. <a href="#">Contact Us</a></p>
                    </div>
                </div>
                <div class="col-6">
                    <div class="right">
                        ...
                        <p class="mail">
                            Mail Us:<a href="mailto:someone@example.com"> info@axela.com</a>
                        </p>
                    </div>
                </div>
            </div>
                        ...
                        <nav class="main-nav">
                            <ul class="mainmenu">
                                ...
                                <li class="has-droupdown">
                                    <a href="#">Services</a>
                                    <ul class="submenu">
                                        <li><a class="single" href="nursing.php">Nursing </a></li>
                                        <li><a class="single" href="alliedhealth.php">Allied Healthcare</a></li>
                                        <li><a class="single" href="therapy.php">Therapy</a></li>
                                    </ul>
                                </li>
                                <li class="">
    ...
    <div id="side-bar" class="side-bar">
        ...
        <div class="rts-sidebar-menu-desktop">
            <a class="logo-1" href="index.php"><img class="logo" src="assets/images/logo/logo-1.png" alt="axela_logo"></a>
            <a class="logo-2" href="index.php"><img class="normal logo" src="assets/images/logo/logo-2.svg" alt="axela-logo"></a>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 col-12 order-lg-1 order-md-2 order-sm-2 order-2 mt_md--50 mt_sm--50 pl--50">
                    <div class="rts-title-area">
                        ...
                        <h3 class="title">We Can Bring Your Business to #1</h3>
                    </div>
        ...
        <div class="container">
            <div class="row mb--10">
                <div class="title-area text-center">
                    <span data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">ITC Healthcare Staffing</span>
                    <h3 class="title" data-sal-delay="250" data-sal="slide-up" data-sal-duration="800">Grow your career with us</h3>
                </div>
            </div>
            <div class="row g-24 mt--5">
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                    ...
                    <div class="rts-single-service-one home-three text-center">
                        ...
                        <p class="disc">
                        With ITC Healthcare Staffing, travel healthcare professionals can make higher pays compare to 
                                non-traveling healthcare professionals. Our pay packages are creative and up market so we know 
                                you want and will match you with positions that meet your needs. And we offer weekly direct deposit so you 
                ...
                <div class="col-12">
                    <div class="cta-two-wrapper">
                        <div class="title-area">
                            <span data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">The best journeyes in life are</span>
                            <h3 class="title" data-sal-delay="250" data-sal="slide-up" data-sal-duration="800">Those that answer questions <br>you never  thought to ask</h3>
                        </div>
                        <div class="cta-contact-box">
                            <div class="left-side">
                                <p data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">Mail us anytime</p>
                                <a href="mailto:itchealthcarestaffing@gmail.com" class="email" data-sal-delay="250" data-sal="slide-up" data-sal-duration="800">Itchealthcarestaffing@gmail.com</a>
                            </div>
        ...
        <div class="container">
            <div class="row mb--30">
                <div class="title-area text-center">
                    <span data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">ITC Healthcare Staffing</span>
                    <h3 class="title" data-sal-delay="250" data-sal="slide-up" data-sal-duration="800">Grow your career with us</h3>
                    <span>Your travel assignment with ITC Healthcare Staffing from first day to last day will be smooth as every step will be assisted with proper guidance.</span>
                    <span>Experienced compliance team takes care of onboarding process and helps get you Started
                        on your assignment with no delay. During the assignment, our recruiters will be available to help you and to ensure that you feel 
                        comfortable with each travel assignment.
                    </span>
                </div>
            </div>
            <div class="row g-24 ">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                    <div class="rts-product-one">
                        ...
                        <div class="product-contact-wrapper text-center">
                            <a href="">
                                <h5 class="title">Competitive Pay  Packages</h5>
                            </a>
                            <span class="">With ITC Healthcare Staffing, travel healthcare professionals can make higher pays compare to 
                                non-traveling healthcare professionals. Our pay packages are creative and up market so we know 
                                you want and will match you with positions that meet your needs. And we offer weekly direct deposit so you 
                                get paid wherever you are.
                            </span>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-sal-delay="250" data-sal="slide-up" data-sal-duration="800">
                    <div class="rts-product-one">
                        ...
                        <div class="product-contact-wrapper text-center">
                            <a href="">
                                <h5 class="title">Reimbursement of cost for</h5>
                            </a>
                            <span>Nursing licenses</span>
                            <span>Certifications</span>
                            <span>Physicals and immunizations</span>
                            <span>Background checks and drug screens</span>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-sal-delay="350" data-sal="slide-up" data-sal-duration="800">
                    <div class="rts-product-one">
                        ...
                        <div class="product-contact-wrapper">
                            <a href="">
                                <h5 class="title">Travel Benefits:</h5>
                            </a>
                            <span>Sign on bonus</span><br/>
                            <span>Housing stipends</span><br/>
                            <span>Direct deposit of your paycheck</span><br/>
                            <span>By weekly Payment</span><br/>
                            <span>Meal & expense stipends</span><br/>
                            <span>Referral bonus</span>
                          
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-6 col-12 m-auto mt-5" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                    <div class="rts-product-one">
                        <div class="thumbnail-area">
                        ...
                        <div class="product-contact-wrapper">
                            <a href="">
                                <h5 class="title">Fulltime Benefits</h5>
                            </a>
                            <span>Health insurance plan</span><br/>
                            <span>Paid time off</span><br/>
                            <span>Dental Insurance</span><br/>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 pr--40 pr_md--0 pr_sm--10">
                    ...
                    <form action="#" class="rts-appoinment-form">
                        <div class="inner">
                            ...
                            <input type="text" name="name" placeholder="Company URL" required>
   ...
   -->
            ...
            <div class="row g-0">
                <div class="col-lg-3">
                    <div class="single-footer-three-wized">
                        <div class="header">
                            <a href="#">
                                <img src="assets/images/logo/logo-04.svg" alt="Footer_logo">
                            </a>
                        </div>
                        <div class="body left" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                            <p class="disc">
                                Our recruiter will contact you within 24  hours of your submission to complete your 
                                application and match you with available positions
                            </p>
                            <ul class="social-area">
                                <li data-sal-delay="150" data-sal="slide-up" data-sal-duration="800" class="sal-animate"><a href="#"><i class="fab fa-facebook-f"></i></a></li>
                                <li data-sal-delay="250" data-sal="slide-up" data-sal-duration="800" class="sal-animate"><a href="#"><i class="fab fa-twitter"></i></a></li>
                ...
                <div class="col-lg-9">
                    <div class="footer-right-three">
                        ...
                        <div class="single-footer-three-wized" data-sal-delay="250" data-sal="slide-up" data-sal-duration="800">
                            ...
                            <div class="body">
                                <ul class="list">
                                    <li><a ><i class="far fa-chevron-double-right"></i>Elder care</a></li>
                                    <li><a ><i class="far fa-chevron-double-right"></i>Nursing Homes</a></li>
                                    <li><a ><i class="far fa-chevron-double-right"></i>Longterm care</a></li>
                                    <li><a ><i class="far fa-chevron-double-right"></i>Hospitals</a></li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="single-footer-three-wized" data-sal-delay="350" data-sal="slide-up" data-sal-duration="800">
                            ...
                            <div class="body">
                                ...
                                <div class="rts-footer-contact">
                                    ...
                                    <a href="#" class="map">
                                    190 Tamarack Cir, Skillman,<br> New Jersey 08558
    ...
    <!-- <div class="container">
        <div class="row">
             <p>
                Your Travel assignment with ITC Healthcare Staffing from first day to last day will be 
                smooth as every step will be assisted with proper guidence.
             </p>
             <p class="box">
                Your Travel assignment with ITC Healthcare Staffing from first day to last day will be 
                smooth as every step will be assisted with proper guidence.
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="wrapper">
                        <div class="left">
                            <a href=""><span class="dot">Privacy Terms</span> </a>
                            <a href="contactus.php"> <span class="dot">Contact Us<span></a>
                        </div>
                        <div class="mid">
                        <p class="dot"> Copyright 2023 Itchealthcarestaffing by <a href="https://www.dotweb.in" target="_blank"> <span class="dot">Dotweb.in</span></a></p>
                        </div>
                        <!-- <div class="right">
