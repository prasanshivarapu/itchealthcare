                        ...
                        <li class="has-droupdown">
                                <a href="#">Services</a>
                                    <ul class="submenu">
                                        <li><a class="single" href="nursing.php">Nursing </a></li>
                                        <li><a class="single" href="alliedhealth.php">Allied Healthcare</a></li>
                                        <li><a class="single" href="">Therapy</a></li>
                                    </ul>
                        </li>
                        <li class="">
                                <a href="career.php">Careers</a> 
            ...
            <div class="row align-items-center">
                ...
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                    <div class="bread-tag">
                        ...
                        <span> / </span>
                        <a href="alliedhealth.php" class="active" data-sal-delay="450" data-sal="slide-up" data-sal-duration="800">Allied Healthcare</a>
                    </div>
                </div>
            </div>
        </div>
