            ...
            <div class="row align-items-center">
                ...
                <div class="col-xl-3 col-lg-10 col-md-9 col-8">
                    <div class="header-right">
                        <a href="contactus.php" class="rts-btn btn-secondary call-btn">contact us
            ...
            <div class="row align-items-center">
                ...
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                    <div class="bread-tag">
                        ...
                        <span> / </span>
                        <a href="nursing.php" class="active" data-sal-delay="450" data-sal="slide-up" data-sal-duration="800">Nursing</a>
                    </div>
                </div>
            </div>
        </div>
