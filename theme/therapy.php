            ...
            <div class="row align-items-center">
                ...
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                    <div class="bread-tag">
                        ...
                        <span> / </span>
                        <a href="therapy.php" class="active" data-sal-delay="450" data-sal="slide-up" data-sal-duration="800">Therapy</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
               ...
               <div  class=" col-12 col-md-6 text-center m-auto">
                   <p>
                      Our providers ara always see for right professionals,
                      who  have a desire o serve, the drive to grow, and voluntarily go the extra mile on behalf 
                      of their customers, colleagues and communities.
                    </p>
               </div>
                ...
                <div class="col-12">
                    <div class="copyu-right-wrapper">
                        <div class="left single">
                            ...
                            <a href="contactus.html" class="ml--20"><span class="dot">Contact Us</span> </a>
                        </div>
                        <div class="left single">
